...
@Mod(StarCraftVoyage.MOD_ID)
public class StarCraftVoyage {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "starcraftvoyage";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();



    public StarCraftVoyage(FMLJavaModLoadingContext context) {
